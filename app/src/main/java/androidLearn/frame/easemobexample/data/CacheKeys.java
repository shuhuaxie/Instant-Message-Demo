...
public class CacheKeys {
  ...
  public static final String INSTALL_CHANNEL = "huimei_install_channel";
  public static final String USER = "huimei_user";
  public static final String TOKEN = "huimei_token";
  ...
  public static final String ORDER_DAILY_INFO = "order_daily_info";
  ...
  public static final String IMAGES = "huimei_image";
  public static final String PATIENT_BASE_INFO = "patient_base_info";
  public static final String TIME_TABLE = "time_table";
  public static final String TEMPLATES_INFO = "templates_info";
